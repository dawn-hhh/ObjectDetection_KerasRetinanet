...
def draw_caption(image, box, caption):
    ...
    cv2.putText(image, caption, (b[0], b[1] - 10), cv2.FONT_HERSHEY_PLAIN, 5, (255, 255, 255), 5, lineType=cv2.LINE_AA)

def draw_caption_debug(image, box, caption):
    """ Draws a caption above the box in an image.
    ...
    """
    b = np.array(box).astype(int)
    cv2.putText(image, caption, (b[0], b[1] - 10), cv2.FONT_HERSHEY_PLAIN, 2, (0, 0, 0), 3, lineType=cv2.LINE_AA)
    cv2.putText(image, caption, (b[0], b[1] - 10), cv2.FONT_HERSHEY_PLAIN, 2, (255, 255, 255), 3, lineType=cv2.LINE_AA)
...
def draw_annotations(image, annotations, color=(0, 255, 0), label_to_name=None):
    ...
    for i in range(annotations['bboxes'].shape[0]):
        ...
        draw_caption_debug(image, annotations['bboxes'][i], caption)
